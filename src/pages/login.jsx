...
export default function Login() {
    ...
    return (
        <div className="main-wrapper bg-gradient-to-b from-[#091732] to-[#0f1014]">
            <div className="logo absolute top-8 left-4">
                <img src="logo.webp" alt="Disney Logo" className="w-12" />
            </div>
            ...
            <div className="wrapper flex flex-col justify-center items-center pt-28 mx-auto w-4/12">
                ...
                <h1>{import.meta.env.REACT_APP_AUTH_URL}</h1>
                ...
                <form className="" onSubmit={(e) => formHandler(e)}>
                        ...
                        <div className="form-number flex justify-between items-center">
                            ...
                            [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
                                onChange={(e) => {
                                    ...
                                    const newFeliu = newVar.replace(/\D/g, "")
                                    checkNumberValidity(e, newFeliu)
                                }} />
                        </div>

                        <div className="form-number flex justify-center mt-5">
                            <input type="password" placeholder="Enter your password" value={password} className="text-xl rounded-md p-4 w-full h-12 bg-transparent border-2 text-white border-[#3a4155]" onChange={(e) => setPassword(e.target.value)} />
                        </div>
                    </div>
                    ...
                    <div className="submit-btn flex justify-center mt-5 mx-20">
                        <button type="submit" disabled={(password && number) === '' ? true : false} className="bg-gradient-to-r from-[#0856e0] to-[#0c1837] rounded font-bold text-white p-2 w-full disabled:opacity-40">Proceed {'>'} </button>
                    </div>
                </form>


            </div>
            <div className="footer flex mt-64 gap-10 justify-between mx-auto w-10/12 py-4 text-white">
                <div className="company flex-col">
                    <h2 className="pb-4 font-bold">Company</h2>
                    <h3 className="font-thin text-md pb-2">Supported Devices</h3>
                    <h3 className="font-thin text-md pb-2">Internet based Ads</h3>
                </div>

                <div className="view-web">
                    <h2 className="pb-4 font-bold">View Website in</h2>
                    <h3 className="font-thin text-md pb-2">English</h3>
                    <h3 className="font-thin text-md pb-2">Indonesia</h3>
                </div>

                <div className="need-help">
                    <h2 className="pb-4 font-bold">Need Help?</h2>
                    <h3 className="font-thin text-md pb-2">Help</h3>
                    <h3 className="font-thin text-md pb-2">Feedback</h3>
                </div>

                <div className="connect">
                    <h2 className="pb-4 font-bold">Connect with Us</h2>
